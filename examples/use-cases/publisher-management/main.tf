...
resource "netskope_npa_publisher_upgrade_profile" "production_weekly" {
  name     = "Production-Weekly-Upgrades"
  enabled  = true
...
resource "netskope_npa_publisher_token" "us_west_1" {
  publisher_id = netskope_npa_publisher.us_west_1.id
}

resource "netskope_npa_publisher_token" "us_west_2" {
  publisher_id = netskope_npa_publisher.us_west_2.id
}

resource "netskope_npa_publisher_token" "us_east_1" {
  publisher_id = netskope_npa_publisher.us_east_1.id
}

resource "netskope_npa_publisher_token" "eu_west_1" {
  publisher_id = netskope_npa_publisher.eu_west_1.id
}
...
resource "netskope_npa_publishers_alerts_configuration" "alerts" {
  ...
  selected_users = "npa-admins@company.com"
...
output "all_publishers" {
  ...
  value = [for p in data.netskope_npa_publishers_list.all.data : {
    id     = p.publisher_id
