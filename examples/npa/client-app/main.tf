...
#
# 5. Protocol Ordering (fixed in provider v0.4.0+)
#    Prior to v0.4.0, protocol ordering caused plan drift. The provider now
#    auto-sorts protocols (TCP ascending by port, then UDP ascending by port)
#    so you can list them in any order. As best practice, we still list them
#    sorted in these examples for readability.
#
# =============================================================================
